...
export const metadata: Metadata = {
  ...
  description: "Pronostics PMU France analysés par notre équipe experte pour les parieurs togolais. Quinté+, Tiercé, Quarté+ via LONATO. Paiement Mobile Money & carte bancaire.",
