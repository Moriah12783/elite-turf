...
export const metadata: Metadata = {
  ...
  description: "Pronostics PMU France analysés depuis Paris pour les turfistes malgaches. Quinté+, Tiercé, Quarté+ avec analyse experte. Mvola, Orange Money & carte bancaire bientôt.",
