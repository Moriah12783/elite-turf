...
export const metadata: Metadata = {
  ...
  description: "Pronostics PMU France analysés depuis Paris pour les parieurs du Burkina Faso. Quinté+, Tiercé, Quarté+ avec analyse experte. Paiement Mobile Money & carte bancaire.",
