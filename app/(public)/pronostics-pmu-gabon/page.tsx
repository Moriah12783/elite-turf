...
export const metadata: Metadata = {
  ...
  description: "Pronostics PMU France analysés par notre équipe experte pour les parieurs gabonais. Quinté+, Tiercé, Quarté+ avec analyse experte. Paiement Mobile Money & carte bancaire.",
