...
export const metadata: Metadata = {
  ...
  description: "Pronostics PMU France analysés depuis Paris pour les parieurs congolais (Brazzaville). Quinté+, Tiercé, Quarté+. Paiement Mobile Money & carte bancaire.",
