...
export default function ModifierPronosticClient({ pronostic, courses }: Props) {
  ...
  const [form, setForm] = useState({
    ...
    niveau_acces: pronostic.niveau_acces || "GRATUIT",
    type_pari: pronostic.type_pari || "TIERCE",
    confiance: pronostic.confiance || "ELEVE",
    analyse_courte: pronostic.analyse_courte || "",
    analyse_texte: pronostic.analyse_texte || "",
    ...
    <div className="max-w-3xl space-y-6">
      ...
      <div className="card-base p-6 space-y-6">
        ...
        <div>
          ...
          {form.course_id && !courses.find((c) => c.id === form.course_id) && (
            <p className="mt-1 text-text-muted text-xs">
              Course actuelle hors des 7 derniers jours — ID : <span className="font-mono">{form.course_id.substring(0, 8)}…</span>
            </p>
          )}
        </div>
