...
export default async function NouveauPronosticPage({
  ...
  searchParams?: { courseId?: string; niveau_acces?: string; type_pari?: string; selection?: string };
}) {
  ...
  const hasParams = !!(sp.courseId || sp.niveau_acces || sp.type_pari || sp.selection);
