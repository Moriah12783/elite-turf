...
<p><strong>Ce n'est pas généralisable aux réunions du soir.</strong> Notre journal scelle les courses dont les cotes de référence sont disponibles à 7h35 ; les réunions nocturnes, dont les cotes n'ouvrent qu'en fin d'après-midi, en sont encore absentes. Nous y travaillons.</p>
...
<p>À partir de cette semaine, nous publierons chaque lundi un <strong>tableau de bord de calibration</strong> : probabilité annoncée contre réalité, par tranche de cotes, sur la semaine écoulée et depuis le début du journal. Les bonnes semaines comme les mauvaises. Et lorsque le prochain pré-enregistrement rendra son verdict — quel qu'il soit — vous le lirez ici.</p>
