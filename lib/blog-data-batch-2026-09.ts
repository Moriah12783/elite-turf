...
<p>Nous préparons un <strong>tableau de bord de calibration</strong> hebdomadaire : probabilité annoncée contre réalité, par tranche de cotes, sur la semaine écoulée et depuis le début du journal. Il sera annoncé ici dès sa mise en ligne, et il montrera les bonnes semaines comme les mauvaises. Et lorsque le prochain pré-enregistrement rendra son verdict — quel qu'il soit — vous le lirez ici.</p>
