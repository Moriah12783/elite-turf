...
const testimonials = [
  ...
  },
  {
    ...
    texte:
      "Abonné Elite depuis 4 mois. Le pronostic Elite du Prix de France m'a rapporté 2 100 000 FCFA (≈ 3 200€). Depuis le Sénégal, on joue via la LONASE sur les mêmes courses PMU. Service exceptionnel.",
    stars: 5,
    initiale: "M",
    gain: "+3 200€",
    gainColor: "text-status-win",
  ...
  },
  {
    ...
    planColor: "text-purple-400 bg-purple-500/10 border-purple-500/30",
    texte:
      "Je joue via le PMU Maroc sur les courses françaises. Le Quinté+ Elite d'il y a 2 semaines m'a rapporté 3 150 000 FCFA (≈ 4 800€) — mon plus grand gain au turf. Je recommande à tous mes amis turfistes.",
    stars: 5,
    initiale: "I",
    gain: "+4 800€",
    gainColor: "text-status-win",
  ...
  },
  {
    ...
    planColor: "text-gold-primary bg-gold-faint border-gold-primary/30",
    texte:
      "La VEDETTE DU JOUR est ma référence. 3 Tiercés gagnants consécutifs en janvier sur Longchamp et Saint-Cloud. Total : 1 950€ en un mois avec le Pack Pro. ROI exceptionnel.",
    stars: 4,
    initiale: "B",
    gain: "+1 950€",
    gainColor: "text-status-win",
