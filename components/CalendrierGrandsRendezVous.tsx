 ...
 * Composant client autonome (Tailwind).
 * Couleurs alignées sur les tokens du thème (tailwind.config.ts) : fond sombre
 * bg-primary/bg-card/bg-hover + or gold-primary/gold-light. Hex en dur ici car
 * réutilisés dans des dégradés et des calculs de style inline.
 */
...
const BG_PAGE = "#1C1C1C";    // bg-primary — fond de section
...
function DateBadge({ evt }: { evt: GrandRendezVous }) {
  ...
  return (
    ...
    >
      <span className="font-serif text-2xl font-bold leading-none" style={{ color: GOLD_LIGHT }}>
  ...
  return (
    <article
      ...
      style={{
        ...
        background: isNext ? "rgba(201,168,76,0.07)" : BG_CARD,
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-5xl">
            ...
            return (
              <button
                ...
                style={{
                  ...
                  color: actif ? BG_DEEP : "rgba(245,241,230,0.75)",
          ...
          {groupes.map((g) => (
            <div key={g.month}>
              <div className="mb-4 flex items-center gap-3">
                <h3 className="font-serif text-xl font-semibold capitalize" style={{ color: GOLD_LIGHT }}>
                  {g.label}
                </h3>
        ...
        {/* Pied de section */}
        <footer className="mt-14 rounded-2xl border p-6 text-center sm:p-8" style={{ borderColor: "rgba(201,168,76,0.25)", background: BG_DEEP }}>
